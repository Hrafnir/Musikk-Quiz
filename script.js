...
// === DOM ELEMENTS ===
// Defineres globalt så de er tilgjengelige overalt
...
async function signInWithGoogle() {
    await supabaseClient.auth.signInWithOAuth({
        provider: 'google',
        options: { redirectTo: 'https://hrafnir.github.io/Musikk-Quiz/index.html' }
    });
}
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    supabaseClient.auth.onAuthStateChange((_event, session) => {
        ...
        if (session) {
            // Håndter retur fra Spotify KUN NÅR vi er logget inn i Supabase
