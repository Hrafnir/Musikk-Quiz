...
// === DOM ELEMENTS (deklareres her, tildeles senere) ===
...
let hasInitialized = false; // For å sikre at hovedlogikken kun kjører én gang

// === SPOTIFY AUTH FUNCTIONS (uendret) ===
...
// ... (andre spotify-funksjoner er uendret)

// === LOBBY & GAME FLOW FUNCTIONS (uendret) ===
...
// === NY, SENTRAL HOVEDFUNKSJON ===
async function runMainLogic() {
    // Denne funksjonen kjører kun når BÅDE DOM og Spotify SDK er klare
    if (!isDomReady || !isSpotifySdkReady || hasInitialized) {
        return;
    }
    hasInitialized = true; // Lås funksjonen for fremtidige kall
    console.log("Både DOM og Spotify SDK er klare. Kjører hovedlogikk.");

    // STEG 1: Legg til event listeners
    ...
    // STEG 2: Kjør autentiseringslogikk
...
window.onSpotifyWebPlaybackSDKReady = () => {
    ...
    runMainLogic(); // Prøv å kjøre hovedlogikken
};

document.addEventListener('DOMContentLoaded', () => {
    console.log("DOMContentLoaded fyrt av.");
...
// --- Kopiert inn uendrede funksjoner (uten DOMContentLoaded eller onSpotifyWebPlaybackSDKReady) ---
