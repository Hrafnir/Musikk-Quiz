...
let currentSong = null; // NYTT
let songHistory = []; // NYTT
let totalSongsInDb = 0; // NYTT

// === SPOTIFY AUTH & PLAYER FUNCTIONS (hentet fra game.js) ===
...
async function startTurn() {
    ...
    if (currentSong) {
        ...
        if (playbackSuccess) {
            ...
            // 3. Send melding til klientene om at turen har startet
            gameChannel.send({
                type: 'broadcast',
                event: 'new_turn',
            ...
            // TODO: Håndter feil, f.eks. ved å prøve en ny sang.
        }
    } else {
