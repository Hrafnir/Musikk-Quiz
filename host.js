...
// NY FUNKSJON: Henter lister for autocomplete
...
// ENDRET: Henter og sender nå autocomplete-lister
async function startGameLoop() {
    ...
    const autocompleteLists = await getAutocompleteLists();
    ...
    gameChannel.send({
        ...
        payload: {
            players: players,
            artistList: autocompleteLists.artistList,
            titleList: autocompleteLists.titleList
        }
    });
